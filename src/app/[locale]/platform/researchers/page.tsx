...
import { Database, Network, ShieldCheck, Code2 } from "lucide-react";
...
export default async function ResearchersPage({
  ...
  const features = [
    ...
    { icon: <Network className="h-5 w-5" />, title: t("researchers_feature2_title"), description: t("researchers_feature2_description") },
  ...
  const integrations = [
    "CEADS", "AgriDataSpace", "FoodDataQuest", "DEMETER", "FutureFoods",
    "EIT Food", "Agriculture of Data", "AGROVOC", "FoodOn", "SAREF",
    "ReCiPe 2016", "Canadian Nutrient File",
  ];
  ...
  return (
    <>
      ...
      <Section className="bg-parchment/50">
        <SectionHeader label="DATA COVERAGE" heading="What the Pipeline Connects" align="center" />
        <div className="mx-auto grid max-w-4xl grid-cols-2 gap-8 md:grid-cols-4">
          {[
            { value: "5,000+", label: "Foods" },
            { value: "150+", label: "Nutrients" },
            { value: "18", label: "LCA Categories" },
            { value: "4", label: "Scoring Systems" },
          ].map((stat) => (
      ...
      {/* Integrations */}
      <Section>
        <SectionHeader label={t("researchers_pipeline_label")} heading="EcoDish365 Integrations" align="center" />
      ...
      <Section dark>
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-serif text-3xl text-white">Access the Research Infrastructure</h2>
          <p className="mt-4 text-white/60">Open-source tools, API access, and collaborative research opportunities for institutions worldwide.</p>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Button href="/contact" size="lg">Request API Access</Button>
